...
<body>
  ...
  <main id="swup" class="transition-fade services">
    ...
    <div class="services-bg" style="background-image: url(app/images/services-bg-4.jpg);">
      <div class="services__title padding-title">Услуги дизайна</div>
      <ul class="services__links">
        <li class="services__links-item">Оформление и декорации</li>
        <li class="services__links-item">Создание артов</li>
        <li class="services__links-item scroll-btn" data-onScroll=".services-item#item-1">Логотипы</li>
        <li class="services__links-item">Полное оформление сайта под ключ</li>
      </ul>
    ...
    <div class="services-item" id="item-1">
      <section class="main">
        <div class="main__title">Логотипы</div>
        <div class="container">
          <div class="main-box">
            <div class="main__content">
              <div class="main__content-text">
                Мы будем рады создать для вас логотип, который принесет вам и вашей компании удачу и успех в будущем.
                Логотип будет сделан с любовью и от души, поэтому он будет заряжать только положительной энергией и
                радовать глаз.
                <br><br>
                Создаем логотип как с нуля, так и по вашему эскизу.
                <br><br>
                Логотип может быть выполнен в разных стилях. Люблю работать в разных направлениях. Все по вашему
                желанию.

              </div>
            </div>
            <img class="main__img" src="app/images/design-img-1.jpg" alt="">
          </div>
        </div>
      </section>
