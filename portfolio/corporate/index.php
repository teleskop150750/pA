...
<body>
  ...
  <main id="swup" class="transition-fade portfolio">
    ...
    <section class="content">
        ...
        <div class="content__order">
          <div class="content__order-btn popup-click">
            ...
            <svg width="26" height="25" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M24.568 10.7933L1.90134 0.126645C1.6731 0.0192456 1.41907 -0.0212042 1.16876 0.009993C0.918441 0.0411902 0.682112 0.142755 0.48721 0.302892C0.292309 0.463029 0.146833 0.675169 0.0676744 0.914677C-0.0114842 1.15419 -0.0210774 1.41124 0.0400093 1.65598L1.65601 8.12131L12 12L1.65601 15.8786L0.0400093 22.344C-0.0222267 22.5889 -0.0134342 22.8465 0.0653583 23.0866C0.144151 23.3267 0.289685 23.5394 0.484938 23.6998C0.680191 23.8603 0.917088 23.9618 1.16792 23.9925C1.41875 24.0232 1.67314 23.9819 1.90134 23.8733L24.568 13.2066C24.7971 13.099 24.9908 12.9283 25.1264 12.7146C25.2621 12.501 25.3341 12.2531 25.3341 12C25.3341 11.7469 25.2621 11.499 25.1264 11.2853C24.9908 11.0716 24.7971 10.901 24.568 10.7933Z"
                fill="white" />
            </svg>
          </div>
      ...
      <svg class="bg-item bg-item-11" width="640" height="1073" viewBox="0 0 640 1073" fill="none"
        xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd"
          d="M546.645 0.767403C656.804 -10.5858 733.623 106.643 816.977 179.564C892.109 245.293 965.215 311.279 1005.83 402.476C1050.16 502.029 1101.71 618.222 1056.48 717.369C1011.64 815.641 878.191 824.703 786.879 882.391C703.965 934.773 641.589 1014.89 546.645 1039.46C430.363 1069.56 297.461 1098.48 195.143 1035.56C91.262 971.671 56.6827 838.801 27.7236 720.323C0.579599 609.272 -21.4186 484.516 36.3404 385.863C91.1933 292.173 227.318 296.798 313.973 231.404C403.327 163.975 435.299 12.243 546.645 0.767403Z"
          fill="#EEF7FB" />
      </svg>
      <svg class="bg-item bg-item-12" width="874" height="1480" viewBox="0 0 874 1480" fill="none"
        xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd"
          d="M-142.5 280.86C-55.2111 212.709 72.1556 271.202 181.515 288.687C280.089 304.448 377.082 321.504 459.945 377.182C550.4 437.962 655.809 509.004 670.171 617.032C684.406 724.106 576.167 802.693 529.465 900.081C487.057 988.513 476.783 1089.53 409.41 1160.79C326.894 1248.08 229.673 1343.2 109.56 1344.26C-12.3904 1345.33 -112.285 1251.14 -199.771 1166.16C-281.773 1086.51 -366.698 992.509 -370.186 878.244C-373.499 769.729 -255.724 701.317 -217.06 599.875C-177.192 495.273 -230.73 349.745 -142.5 280.86Z"
          fill="#EEF7FB" />
      </svg>
    </section>
  </main>
