...
<body>
  ...
  <main id="swup" class="transition-fade portfolio">
    <section class="main" style="background-image: url(app/images/portfolio-bg-5.jpg);">
      <div class="main__item">агроальянс</div>
    </section>
    ...
    <section class="content">
      <div class="container">
        ...
        <div class="content__text">
          ...
          <br><br>
          Гости оказываются в сказке, в которую им помогают погрузиться яркие декорации – фигуры богатырей,
          Змея-горыныча, избушка.
          <br><br>
          Декорации разноплановые – яркие и в более спокойных (сине-белые) тонах.
          <br><br>
          В зале есть сцена, на которой установили музыкальное оборудование, чтобы вечер гостей был наполнен приятной
          музыкой.
        </div>
        <div class="content__title">Галерея</div>
        <div class="content__gallery" style="background-image: url(app/images/portfolio-bg-5.jpg);">
  ...
  <script>
    ...
    function init() {
      ...
      allObject = [{
        ...
        {
          nameImg: 'LGD_0014.jpg',
          positionX: 1.3,
          positionZ: 0.54,
          rotationY: -Math.PI / 4,
        },
        {
          nameImg: 'LGD_0019.jpg',
          positionX: -1.3,
          positionZ: 0.54,
          rotationY: Math.PI / 4,
        },
        ...
        {
          nameImg: 'LGD_0008.jpg',
          positionX: -0.245,
          positionZ: 3.515,
          rotationY: (5 * Math.PI) / 4,
        },
        {
          nameImg: 'LGD_0049.jpg',
          positionX: 1,
          positionZ: 3,
          rotationY: Math.PI,
        },
        ...
        {
          nameImg: 'IMG_9962.jpg',
          positionX: -4,
          positionZ: 3.5,
          rotationY: Math.PI / 2,
        },
        {
          nameImg: 'LGD_0007.jpg',
          positionX: -3.46,
          positionZ: 4.8,
        ...
        {
          nameImg: 'LGD_0021.jpg',
          positionX: 0,
          positionZ: 7,
          rotationY: Math.PI,
        },
        {
          nameImg: 'IMG_9977.jpg',
          positionX: 1.3,
          positionZ: 6.46,
          rotationY: (5 * Math.PI) / 4,
        },
        {
          nameImg: 'LGD_9993.jpg',
          positionX: -1.3,
          positionZ: 6.46,
          rotationY: (3 * Math.PI) / 4,
        },
      ...
      for (const iterator of allObject) {
        let materials = [
          ...
          new THREE.MeshBasicMaterial({
            map: loader.load('app/images/corporate_agroalliance/' + iterator.nameImg)
          }),
          new THREE.MeshBasicMaterial({
            color: 0x242424,
            flatShading: true
      ...
      allObject = [{
        ...
        {
          nameImg: 'IMG_9994.jpg',
          positionX: -4.5,
          positionZ: 0.8,
          rotationY: Math.PI / 2,
        },
        {
          nameImg: 'LGD_9997.jpg',
          positionX: -3.2,
          positionZ: -0.5,
          rotationY: 0,
        },
