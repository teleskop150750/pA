...
<head>
  ...
  <title>Юбилей 50-ти летия</title>
...
<body>
  ...
  <main id="swup" class="transition-fade portfolio">
    <section class="main" style="background-image: url(app/images/portfolio-bg-4.jpg);">
      <div class="main__item">юбилей 50-ти летия</div>
    </section>
    ...
    <section class="content">
      <div class="container">
        ...
        <div class="content__text">
          Веселый праздник должен был сделан в ярких цветах, с активной музыкой, красочными выступлениями, вкусными
          угощениями.
          <br><br>
          В этот раз мероприятие было выполнено в определенной тематике – казино, карты, бар. Наши организаторы
          постарались максимально передать атмосферу лихого веселья. Декорации разноплановые: перед тем, как гости
          попадают в бар с огнями, они проходят через светлые комнаты.
          <br><br>
          Их оформление выполнено в простом стиле, который не режет глаз и не будоражит яркими цветами, а успокаивает,
          настраивает гостя на предстоящее веселье.
        </div>
        <div class="content__title">Галерея</div>
        <div class="content__gallery" style="background-image: url(app/images/portfolio-bg-4.jpg);">
  ...
  <script>
    ...
    function init() {
      ...
      allObject = [{
        ...
        {
          nameImg: 'HRIS4434.jpg',
          positionX: 1.3,
          positionZ: 0.54,
          rotationY: -Math.PI / 4,
        },
        {
          nameImg: 'IMG_2274.jpg',
          positionX: -1.3,
          positionZ: 0.54,
          rotationY: Math.PI / 4,
        },
        ...
        {
          nameImg: 'HRIS3545.jpg',
          positionX: -0.245,
          positionZ: 3.515,
          rotationY: (5 * Math.PI) / 4,
        },
        {
          nameImg: 'IMG_1699.jpg',
          positionX: 1,
          positionZ: 3,
          rotationY: Math.PI,
        },
        ...
        {
          nameImg: 'IMG_1856.jpg',
          positionX: -4,
          positionZ: 3.5,
          rotationY: Math.PI / 2,
        },
        {
          nameImg: 'IMG_1862.jpg',
          positionX: -3.46,
          positionZ: 4.8,
        ...
        {
          nameImg: 'HRIS3534.jpg',
          positionX: 0,
          positionZ: 7,
          rotationY: Math.PI,
        },
        {
          nameImg: 'HRIS3543.jpg',
          positionX: 1.3,
          positionZ: 6.46,
          rotationY: (5 * Math.PI) / 4,
        },
        {
          nameImg: 'HRIS3567.jpg',
          positionX: -1.3,
          positionZ: 6.46,
          rotationY: (3 * Math.PI) / 4,
        },
        ...
        {
          nameImg: 'HRIS3587.jpg',
          positionX: 4,
          positionZ: 3.5,
          rotationY: -Math.PI / 2,
        },
        {
          nameImg: 'HRIS3957.jpg',
          positionX: 3.46,
          positionZ: 2.2,
          rotationY: -Math.PI / 4,
        },
        {
          nameImg: 'HRIS4199.jpg',
          positionX: 3.46,
          positionZ: 4.8,
          rotationY: (-3 * Math.PI) / 4,
        },
      ...
      for (const iterator of allObject) {
        let materials = [
          ...
          new THREE.MeshBasicMaterial({
            map: loader.load('app/images/jubilee/' + iterator.nameImg)
          }),
          new THREE.MeshBasicMaterial({
            color: 0x242424,
            flatShading: true
      ...
      allObject = [{
        ...
        {
          nameImg: 'IMG_1712.jpg',
          positionX: -4.5,
          positionZ: 0.8,
          rotationY: Math.PI / 2,
        },
        {
          nameImg: 'HRIS3542.jpg',
          positionX: -3.2,
          positionZ: -0.5,
          rotationY: 0,
        },
      ...
      for (const iterator of allObject) {
        geometry = new THREE.CubeGeometry(0.565, 0.85, 0.1);
        let materials = [
          new THREE.MeshBasicMaterial({
            color: 0x242424,
            flatShading: true
