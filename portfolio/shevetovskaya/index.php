...
<body>
  ...
  <main id="swup" class="transition-fade portfolio">
    <section class="main" style="background-image: url(app/images/portfolio-bg-2.jpg);">
      <div class="main__item">сайт Шеветовская</div>
    </section>
    ...
    <section class="content">
      <div class="container">
        ...
        <div class="content__text">
          Для проведения мероприятия был арендован вместительный зал, чтобы комфортно могли разместиться и гости, и
          актеры, подготовившие интересную программу.
          <br><br>
          В неё вошли несколько танцевальных номеров разных жанров, начиная от спокойного медленного танца в белых
          одеждах и завершая страстным танго. В плане декораций было принято решение прибегнуть к минимализму, поэтому
          упор был сделан на световые эффекты.
          <br><br>
          Завершением мероприятия стал салют. Огни красного цвета имели особенный эффект для зрителей, которые покинули
          зал, погруженный в полутьму.
        </div>
        <div class="content__title">Галерея</div>
        <div class="content__gallery" style="background-image: url(app/images/portfolio-bg-2.jpg);">
  ...
  <script>
    ...
    function init() {
      ...
      allObject = [{
        ...
        {
          nameImg: 'SSH_0002.jpg',
          positionX: 1.3,
          positionZ: 0.54,
          rotationY: -Math.PI / 4,
        },
        {
          nameImg: 'SSH_0010.jpg',
          positionX: -1.3,
          positionZ: 0.54,
          rotationY: Math.PI / 4,
        },
        ...
        {
          nameImg: 'SSH_0459.jpg',
          positionX: -4,
          positionZ: 3.5,
          rotationY: Math.PI / 2,
        },
        {
          nameImg: 'SSH_0448.jpg',
          positionX: -3.46,
          positionZ: 4.8,
        ...
        {
          nameImg: 'SSH_0541.jpg',
          positionX: 0,
          positionZ: 7,
          rotationY: Math.PI,
        },
        {
          nameImg: 'SSH_0528.jpg',
          positionX: 1.3,
          positionZ: 6.46,
          rotationY: (5 * Math.PI) / 4,
        },
        {
          nameImg: 'SSH_0508.jpg',
          positionX: -1.3,
          positionZ: 6.46,
          rotationY: (3 * Math.PI) / 4,
        },
      ...
      for (const iterator of allObject) {
        let materials = [
          ...
          new THREE.MeshBasicMaterial({
            map: loader.load('app/images/shevetovskaya/' + iterator.nameImg)
          }),
          new THREE.MeshBasicMaterial({
            color: 0x242424,
            flatShading: true
      ...
      let materials = [
        ...
        new THREE.MeshBasicMaterial({
          map: loader.load('app/images/shevetovskaya/SSH_0412.jpg')
        }),
        new THREE.MeshBasicMaterial({
          color: 0x242424,
          flatShading: true
